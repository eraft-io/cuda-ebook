...
\subsection{概述}
本章节详细讲解如何使用 \textbf
{WMMA (Warp Matrix Multiply-Accumulate) API} 对 NVIDIA GPU 的张
...
\subsection{总结与展望}
本章完整展示了 WMMA API 的基本用法及编译要求。张量核心编程不仅适用于矩阵乘法，还可扩展至cuBLAS、cuDNN 等库的底层加速。掌握架构感知的编译习惯与性能度量方法，是进行高效 GPU 并行编程的基础。
