...
colin@colin-BATTLE-AX-B860M-P-WIFI:~/cuda_ebook$ sudo /usr/local/cuda-13/bin/ncu ./vec_add
==PROF== Connected to process 3036 (/home/colin/cuda_ebook/vec_add)
==PROF== Profiling "vectorAdd" - 0: 0%....50%....100% - 9 passes
COMPLETED SUCCESSFULLY
==PROF== Disconnected from process 3036
[3036] vec_add@127.0.0.1
  vectorAdd(const int *, const int *, int *, int) (64, 1, 1)x(1024, 1, 1), Context 1, Stream 7, Device 0, CC 12.0
    Section: GPU Speed Of Light Throughput
    ----------------------- ----------- ------------
    Metric Name             Metric Unit Metric Value
    ----------------------- ----------- ------------
    DRAM Frequency                  Ghz        13.45
    SM Frequency                    Ghz         2.40
    Elapsed Cycles                cycle        5,931
    Memory Throughput                 %        24.84
    DRAM Throughput                   %        24.84
    Duration                         us         2.46
    L1/TEX Cache Throughput           %        10.44
    L2 Cache Throughput               %        13.04
    SM Active Cycles              cycle     2,484.90
    Compute (SM) Throughput           %         6.93
    ----------------------- ----------- ------------

    OPT   This kernel grid is too small to fill the available resources on this device, resulting in only 0.91 full
    ...
    OPT   Est. Speedup: 8.571%
          The grid for this launch is configured to execute only 64 blocks, which is less than the 70 multiprocessors
    ...
    Achieved Occupancy                        %        54.80
    Achieved Active Warps Per SM           warp        26.30
    ------------------------------- ----------- ------------

    OPT   Est. Local Speedup: 17.81%
          The difference between calculated theoretical (66.7%) and measured achieved occupancy (54.8%) can be the
    ...
    Metric Name                Metric Unit Metric Value
    -------------------------- ----------- ------------
    Average DRAM Active Cycles       cycle        8,236
    Total DRAM Elapsed Cycles        cycle      265,216
    Average L1 Active Cycles         cycle     2,484.90
    Total L1 Elapsed Cycles          cycle      414,270
    Average L2 Active Cycles         cycle     2,386.17
    Total L2 Elapsed Cycles          cycle      126,432
    Average SM Active Cycles         cycle     2,484.90
    Total SM Elapsed Cycles          cycle      414,270
    Average SMSP Active Cycles       cycle     2,411.47
    Total SMSP Elapsed Cycles        cycle    1,657,080
    -------------------------- ----------- ------------

    OPT   Est. Speedup: 7.462%
          One or more SMs have a much lower number of active cycles than the average number of active cycles. Maximum
          instance value is 17.77% above the average, while the minimum instance value is 100.00% below the average.
 
    OPT   Est. Speedup: 7.972%
          One or more SMSPs have a much lower number of active cycles than the average number of active cycles. Maximum
          instance value is 19.56% above the average, while the minimum instance value is 100.00% below the average.
    
    OPT   Est. Speedup: 7.462%
          One or more L1 Slices have a much lower number of active cycles than the average number of active cycles.
          Maximum instance value is 17.77% above the average, while the minimum instance value is 100.00% below the
          average.
   
    OPT   Est. Speedup: 7.754%
          One or more L2 Slices have a much higher number of active cycles than the average number of active cycles.
          Maximum instance value is 17.12% above the average, while the minimum instance value is 8.81% below the
          average.
...
NVIDIA GeForce RTX 5070 Ti 上运行结果


\begin{lstlisting}
Max_threads_per_SM 0: 1536
Max_warps_per_SM   0: 48


Max_threads_per_SM 1: 1536
Max_warps_per_SM   1: 48
\end{lstlisting}
